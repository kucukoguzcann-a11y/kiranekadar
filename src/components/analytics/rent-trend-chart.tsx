...
export default function RentTrendChart({ data }: RentTrendChartProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="flex items-start justify-between gap-3 px-4 py-4 border-b border-gray-50 sm:px-6 sm:py-5">
        <div className="min-w-0">
          ...
          <p className="text-[11px] text-gray-400 mt-1 ml-9 leading-4 sm:text-xs">Son 12 ayda bölgedeki medyan kira gelişimi</p>
        </div>
      ...
      <div className="h-[240px] pt-4 pr-2 pb-2 sm:h-[280px] sm:pr-4">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={processedData} margin={{ top: 10, right: 8, left: 0, bottom: 0 }}>
            <defs>
